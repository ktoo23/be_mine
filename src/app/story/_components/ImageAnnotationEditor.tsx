...
import { AnnotatorImage } from '../../diary/write/_component/types';
import CustomUi from '@/app/diary/write/_component/CustomTldrawEditor';
...
export function ImageAnnotationEditor({
  ...
  return (
    <div style={{ width: '400px', height: '600px' }}>
      ...
      />
      <CustomUi imageShapeId={imageShapeId as TLShapeId} onDone={onDone} />
    </div>
  );
}
